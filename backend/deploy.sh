...
# Configuration
DOMAINS=("backend.devtools-co.com" "devtools-co.com" "docs.devtools-co.com")
EMAIL="${SSL_EMAIL:-admin@devtools-co.com}"
...
show_next_steps() {
    ...
    echo ""
    echo "Services:"
    echo -e "  ${BLUE}Backend API:${NC} https://backend.devtools-co.com"
    echo -e "  ${BLUE}Main Site:${NC} https://devtools-co.com"
    echo -e "  ${BLUE}Documentation:${NC} https://docs.devtools-co.com"
    echo -e "  ${BLUE}Admin Panel:${NC} https://backend.devtools-co.com/admin"
    echo -e "  ${BLUE}API Docs:${NC} https://backend.devtools-co.com/api/docs"
    echo ""
    echo "CLI Installation:"
    echo -e "  ${BLUE}curl -fsSL https://devtools-co.com/install.sh | bash${NC}"
    echo ""
