...
Uses requests library in a thread pool for reliable SSE streaming.
"""
...
class ExternalAIClient:
    ...
    async def generate_stream(
        ...
        # Don't add model parameter when thinking mode is enabled
        # as it causes the external AI to not send thinking events
                ...
                if line_str.startswith('data: '):
                    ...
                    try:
                        ...
                        if event_type == "thinking_start":
                            ...
                            # Handle 'response' type (sent when model param is included)
                            yield {"type": "content", "content": data.get("content", "")}
