...
from services.external_ai_client_new import ExternalAIClient

async def test_client():
    """Test the new external AI client."""

    client = ExternalAIClient()

    print("Testing New External AI Client with thinking mode...")
    print("=" * 60)
