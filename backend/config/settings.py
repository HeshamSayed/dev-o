"""
Django settings for AI Project Builder.
"""
...
INSTALLED_APPS = [
    ...
    # Custom apps with models (must come before django.contrib.admin for custom user model)
    'apps.users',  # Custom user model - must be before admin
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'ai_project_builder'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for AI-powered full-stack project generation',
    'VERSION': '1.0.0',
}
