...
class ChatSession:
    ...
    def handle_interrupt(self):
        ...
        if self.waiting_for_input:
            # If waiting for input, just cancel
        ...
        self.console.print("1. Pause and ask a question")
        self.console.print("2. Cancel current task")
        self.console.print("3. Continue processing")
        self.console.print("4. Save checkpoint and exit")
        self.console.print()
        ...
        if choice == "1":
            ...
            self.console.print("[cyan]Continuing...[/cyan]\n")
            return
        elif choice == "4":
            self.save_and_exit()
